...
大家好，我是 Liman。今天开源一款我开发的**桌面简历整理工具**，帮助大家快速整理散落在电脑各处的简历文件。

> 💡 **桌面应用说明**：这是一个安装在电脑上运行的软件，不需要浏览器，双击图标即可使用。
...
> 💡 **说明**：这是一个桌面应用程序，下载安装包后双击运行，无需浏览器或网络连接。
...
大家好，分享一款我开发的桌面简历整理工具。

> 💡 这是一个桌面应用程序，不是 Web 产品。下载安装包后双击运行，无需浏览器。
...
> 💡 **产品形态**：这是一个桌面应用程序（Desktop App），下载安装后双击图标即可运行，不需要浏览器或网络连接。
